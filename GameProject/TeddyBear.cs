...
namespace GameProject
{
    ...
    public class TeddyBear
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            {
                int y = drawRectangle.Y + GameConstants.TeddyBearProjectileOffset;
                Projectile newTeddyBearProjectile = new Projectile(ProjectileType.TeddyBear, Game1.GetProjectileSprite(ProjectileType.TeddyBear), 
                    drawRectangle.X +drawRectangle.Width/2, y,GetProjectileYVelocity());
                Game1.AddProjectile(newTeddyBearProjectile);
                shootSound.Play();
